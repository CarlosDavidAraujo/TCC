...
**Cenário: Tela de Lista de Tarefas**
...
Forneça a implementação "Boa" para este cenário de tela de lista de tarefas, abordando contraste de texto, rótulos ausentes e tamanho do alvo de toque.
